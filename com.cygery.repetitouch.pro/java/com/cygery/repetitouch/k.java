...
extends Event {
    ...
    static final long serialVersionUID = -8041374199260006864L;
    protected int c;
    protected int d;
    protected short e;
    protected short f;
    ...
    public k(int n2, int n3, short s2, short s3, int n4) {
    ...
    public k(short s2, int n2, int n3, short s3, short s4, int n4) {
        this.h = s2;
        this.c = n2;
        this.d = n3;
        this.e = s3;
    ...
    public k(short s2, short s3, int n2) {
        super(0, 0, s2, s3, n2);
    }
