...
final /* synthetic */ class StaticTrackingService$$Lambda$1 implements Predicate {
    private final DraftAdMetadataAttribute arg$1;

    private StaticTrackingService$$Lambda$1(DraftAdMetadataAttribute draftAdMetadataAttribute) {
    ...
    public static Predicate lambdaFactory$(DraftAdMetadataAttribute draftAdMetadataAttribute) {
        return new StaticTrackingService$$Lambda$1(draftAdMetadataAttribute);
    }
