...
public class PreviewGalleryActivity extends BaseActivity implements LoaderCallbacks<Cursor> {
    private static final String ALPHA = "alpha";
    private static final int ANIM_END_TIME = 255;
    ...
    private static final int LOADER_PICTURES_PREVIEW = 0;
    ...
    private PreviewGalleryPagerAdapter pagerAdapter;
    ...
    class DetailOnPageChangeListener extends SimpleOnPageChangeListener {
        ...
        public void onPageSelected(int i) {
            PreviewGalleryActivity.this.mCurrentPos = i;
            PreviewGalleryActivity.this.pageIndicator.setText(PreviewGalleryActivity.this.getString(2131165471, new Object[]{Integer.valueOf(PreviewGalleryActivity.this.getNonEdgeImagePosition(i)), Integer.valueOf(PreviewGalleryActivity.this.mImgsNum)}));
            PreviewGalleryActivity.this.pageIndicator.setVisibility(0);
        }

        public void onPageScrollStateChanged(int i) {
            int access$400 = PreviewGalleryActivity.this.getNonEdgeImagePosition(PreviewGalleryActivity.this.mCurrentPos);
            if (access$400 != PreviewGalleryActivity.this.mCurrentPos) {
                PreviewGalleryActivity.this.pager.setCurrentItem(access$400, false);
            }
            PreviewGalleryActivity.this.mEventBus.post(new OnGalleryItemWatchEvent(access$400 - 1, false));
        }
    }

    public static Intent createIntent(Context context, String str, String str2, String str3) {
        Intent intent = new Intent(context, PreviewGalleryActivity.class);
    ...
    private void initEnterAnimation() {
        ...
        this.pager.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            public boolean onPreDraw() {
                PreviewGalleryActivity.this.pager.getViewTreeObserver().removeOnPreDrawListener(this);
                PreviewGalleryActivity.this.updateImageTransitionParams(rect);
                PreviewGalleryActivity.this.runEnterAnimation();
                return true;
            }
        });
    }
    ...
    private void initializeWithDefaultValues() {
        this.vipId = Long.valueOf(getIntent().getStringExtra(StatefulActivity.EXTRA_POST_AD_ID)).longValue();
    ...
    private void initPager() {
        ...
        this.pagerAdapter = new PreviewGalleryPagerAdapter(this, getLayoutInflater(), new EmptyCursor(), this.mEventBus);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        switch (i) {
            case ConversationsIntentService.DEFAULT_PAGE /*0*/:
                return new CursorLoader(getApplicationContext(), PostAdsImages.URI, new String[]{"href", "_id"}, "ad_id=? AND href!=?", new String[]{String.valueOf(this.vipId), BuildConfig.FLAVOR}, null);
            default:
    ...
    public void runEnterAnimation() {
        ...
        ObjectAnimator ofInt = ObjectAnimator.ofInt(this.mBackground, ALPHA, new int[]{0, ANIM_END_TIME});
        ...
        if (VERSION.SDK_INT < 16) {
            translationY.setListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    ...
                    PreviewGalleryActivity.this.overridePendingTransition(0, 0);
                }
            });
        } else {
    ...
    public void onBackPressed() {
        ...
        runExitAnimation(PreviewGalleryActivity$$Lambda$1.lambdaFactory$(this));
    }
