...
public class GridFragment extends Fragment {
    private static final String CANNOT_BE_USED_WITH_A_CUSTOM_CONTENT_VIEW = "Can't be used with a custom content view";
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = GridFragment$$Lambda$1.lambdaFactory$(this);
    View mProgressContainer;
    private final Runnable mRequestFocus = new 1(this);
    TextView mStandardEmptyView;

    /* synthetic */ void lambda$new$0(AdapterView adapterView, View view, int i, long j) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        textView = new GridView(getActivity());
    ...
    public void setEmptyText(CharSequence charSequence) {
        ...
        if (this.mStandardEmptyView == null) {
            throw new IllegalStateException(CANNOT_BE_USED_WITH_A_CUSTOM_CONTENT_VIEW);
        }
