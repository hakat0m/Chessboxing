...
@Deprecated
public final class SupportGeocoderLoader extends AsyncTaskLoader<GeocoderResult> {
    private static final int LOADER_ID = 6507;
    private GeocoderResult geocoderResult;
    private final GeocoderRequest request;

    private SupportGeocoderLoader(Context context, GeocoderRequest geocoderRequest) {
        super(context.getApplicationContext());
        this.request = geocoderRequest;
    }

    public static SupportGeocoderLoader newLoader(Context context, Bundle bundle) {
        return new SupportGeocoderLoader(context, (GeocoderRequest) bundle.getSerializable("request"));
    }
