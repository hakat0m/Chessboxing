package com.gumtree.android.srp.dfp;
...
public class SRPDFPProcessor extends DFPProcessor {
    private static final String AD_UNIT_STANDARD_BANNER = "/5144/m.android.srp.";
    private static final String AD_UNIT_STANDARD_TABLET_BANNER = "/5144/t.android.srp.";
    private static final String LEADERBOARD_BANNER = "/5144/t.android.srp.";
    private static final String MPU_BANNER = "/5144/m.android.srp.";
    private static final String MPU_TABLET_BANNER = "/5144/t.android.srp.";
    ...
    public AdSize[] getStickyBannerSizes() {
        return new AdSize[]{AdSize.BANNER};
    }

    public String getStickyBanner(String str) {
        return getAdUnitId(str, MPU_BANNER);
    }
}
