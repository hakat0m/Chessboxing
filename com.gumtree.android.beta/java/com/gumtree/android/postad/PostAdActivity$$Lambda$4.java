...
final /* synthetic */ class PostAdActivity$$Lambda$4 implements OnFieldValueChangeListener {
    private final PostAdActivity arg$1;

    private PostAdActivity$$Lambda$4(PostAdActivity postAdActivity) {
        this.arg$1 = postAdActivity;
    }

    public static OnFieldValueChangeListener lambdaFactory$(PostAdActivity postAdActivity) {
        return new PostAdActivity$$Lambda$4(postAdActivity);
    }

    @Hidden
    public void onFieldValueChange(String str) {
        this.arg$1.lambda$initTextListeners$3(str);
    }
}
