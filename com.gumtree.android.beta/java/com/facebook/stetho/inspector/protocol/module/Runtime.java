...
public class Runtime implements ChromeDevtoolsDomain {
    ...
    class CallFunctionOnResponse implements JsonRpcResult {
        @JsonProperty
    ...
    class EvaluateRequest implements JsonRpcResult {
    ...
    class EvaluateResponse implements JsonRpcResult {
        @JsonProperty
    ...
    class GetPropertiesRequest implements JsonRpcResult {
        @JsonProperty(required = true)
        public String objectId;
        @JsonProperty(required = true)
    ...
    class GetPropertiesResponse implements JsonRpcResult {
        @JsonProperty(required = true)
    ...
    class Session {
        ...
        private GetPropertiesResponse getPropertiesForProtoContainer(ObjectProtoContainer objectProtoContainer) {
            ...
            propertyDescriptor.name = PaymentConverter.DEFAULT_PAYMENT_METHOD_ID;
    ...
    private static synchronized Session getSession(JsonRpcPeer jsonRpcPeer) {
        ...
        synchronized (Runtime.class) {
            ...
            if (session == null) {
                ...
                jsonRpcPeer.registerDisconnectReceiver(new 2(jsonRpcPeer));
            }
        }
        return session;
    }
