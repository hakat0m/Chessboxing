...
public class DOM implements ChromeDevtoolsDomain {
    ...
    class GetSearchResultsResponse implements JsonRpcResult {
        @JsonProperty(required = true)
    ...
    class PerformSearchResponse implements JsonRpcResult {
        @JsonProperty(required = true)
    ...
    public JsonRpcResult getDocument(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        getDocumentResponse.root = (Node) this.mDocument.postAndWait(new 1(this));
    ...
    public void highlightNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (rGBAColor == null) {
            ...
            this.mDocument.postAndWait(new 2(this, highlightNodeRequest, rGBAColor));
        }
    }
    ...
    public ResolveNodeResponse resolveNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) throws JsonRpcException {
        ...
        Object postAndWait = this.mDocument.postAndWait(new 4(this, resolveNodeRequest));
        if (postAndWait == null) {
    ...
    public void setAttributesAsText(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        this.mDocument.postAndWait(new 5(this, (SetAttributesAsTextRequest) this.mObjectMapper.convertValue(jSONObject, SetAttributesAsTextRequest.class)));
    }

    @ChromeDevtoolsMethod
    public void setInspectModeEnabled(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        this.mDocument.postAndWait(new 6(this, (SetInspectModeEnabledRequest) this.mObjectMapper.convertValue(jSONObject, SetInspectModeEnabledRequest.class)));
    }
    ...
    public PerformSearchResponse performSearch(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        this.mDocument.postAndWait(new 7(this, performSearchRequest, arrayListAccumulator));
