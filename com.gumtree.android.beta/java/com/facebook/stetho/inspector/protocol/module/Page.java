...
public class Page implements ChromeDevtoolsDomain {
    ...
    class GetResourceTreeParams implements JsonRpcResult {
        @JsonProperty(required = true)
    ...
    public class ScreencastFrameEventMetadata {
        @JsonProperty(required = true)
    ...
    private void notifyExecutionContexts(JsonRpcPeer jsonRpcPeer) {
        ...
        executionContextDescription.frameId = PaymentConverter.DEFAULT_PAYMENT_METHOD_ID;
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        FrameResourceTree createSimpleFrameResourceTree = createSimpleFrameResourceTree(PaymentConverter.DEFAULT_PAYMENT_METHOD_ID, null, "Stetho", it.hasNext() ? (String) it.next() : BuildConfig.FLAVOR);
        ...
        while (it.hasNext()) {
            ...
            createSimpleFrameResourceTree.childFrames.add(createSimpleFrameResourceTree(stringBuilder, PaymentConverter.DEFAULT_PAYMENT_METHOD_ID, "Child #" + stringBuilder, (String) it.next()));
            i = i2;
        }
    ...
    private static FrameResourceTree createSimpleFrameResourceTree(String str, String str2, String str3, String str4) {
        ...
        frame.id = str;
        frame.parentId = str2;
        frame.loaderId = PaymentConverter.DEFAULT_PAYMENT_METHOD_ID;
        frame.name = str3;
